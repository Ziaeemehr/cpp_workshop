...
int main()
{
    ...
    auto a14 = nc::random::randInt<int>({ 5, 5 }, 0, 30);
    // cout << nc::size(a14) << endl;
    // cout << nc::shape(a14) << endl;
    auto value = a14(2, 3);
    auto slice = a14({ 1, 3 }, { 1, 3 });
    auto colSlice = a14(a14.cSlice(), 1);
    auto rowSlice = a14(1, a14.rSlice());
    auto values = a14[a14 > 26];
    // a14.putMask(a14 > 20, 666);
    // cout << a14 << endl;
    // cout << rowSlice << endl;
    // cout << colSlice << endl;
    // cout << values << endl;
